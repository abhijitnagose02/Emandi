...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "bot",
      text: `Hello! I am your FarmLink Assistant. How can I help you as a ${currentUser.role}?`,
      time: "Just now"
    }
  ]);
  ...
  const roleQuestions = {
    Farmer: [
      ...
      { q: "How does consolidated delivery work?", a: "Instead of booking an entire truck for your lot alone, FarmLink groups compatible harvest orders heading along the same highway to the same market. Transporters make scheduled farm pickups, significantly lowering your transport cost share." },
    ...
    Buyer: [
      ...
      { q: "What is the 75% immediate transport rule?", a: "If you need fast dedicated dispatch without waiting for route pooling, you can select Immediate Delivery. Under FarmLink's rule, the customer pays 75% of the dedicated transport cost (e.g., ₹750 on a ₹1,000 trip)." },
    ...
    Transporter: [
      ...
      { q: "How do multi-stop pickups work?", a: "For consolidated trips (e.g., TR-104), FarmLink organizes an optimized sequence of farm stops (Stop 1 Katol, Stop 2 Kalmeshwar, Stop 3 Saoner). Click 'Confirm Pickup' at each farm once loaded." },
  ...
  const handleSend = (textToSend) => {
    ...
    setTimeout(() => {
      ...
      if (matched) {
        ...
        reply = "FarmLink negotiation allows direct price bargaining. Farmer sets asking price, Buyer makes offer, and both parties can counter-offer until a mutually agreed price is accepted.";
      }
  ...
  return (
    <>
      ...
      >
        ...
        <span className="font-bold text-sm tracking-wide">Ask FarmLink</span>
